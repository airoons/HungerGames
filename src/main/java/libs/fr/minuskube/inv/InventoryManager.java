package libs.fr.minuskube.inv;

import libs.fr.minuskube.inv.content.InventoryContents;
import libs.fr.minuskube.inv.opener.ChestInventoryOpener;
import libs.fr.minuskube.inv.opener.InventoryOpener;
import libs.fr.minuskube.inv.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<UUID, libs.fr.minuskube.inv.SmartInventory> inventories;
    ...
    public List<Player> getOpenedPlayers(libs.fr.minuskube.inv.SmartInventory inv) {
    ...
    public Optional<libs.fr.minuskube.inv.SmartInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    protected void setInventory(Player p, libs.fr.minuskube.inv.SmartInventory inv) {
        if (inv == null)
    ...
    public void handleInventoryOpenError(libs.fr.minuskube.inv.SmartInventory inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while opening SmartInventory:", exception);
    }

    public void handleInventoryUpdateError(libs.fr.minuskube.inv.SmartInventory inventory, Player player, Exception exception) {
        inventory.close(player);
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                libs.fr.minuskube.inv.SmartInventory inv = inventories.get(p.getUniqueId());
                ...
                inv.getListeners().stream()
                        ...
                        .forEach(listener -> ((libs.fr.minuskube.inv.InventoryListener<InventoryClickEvent>) listener).accept(e));
        ...
        public void onInventoryDrag(InventoryDragEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((libs.fr.minuskube.inv.InventoryListener<InventoryDragEvent>) listener).accept(e));
        }
        ...
        public void onInventoryOpen(InventoryOpenEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((libs.fr.minuskube.inv.InventoryListener<InventoryOpenEvent>) listener).accept(e));
        }
        ...
        public void onInventoryClose(InventoryCloseEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((libs.fr.minuskube.inv.InventoryListener<InventoryCloseEvent>) listener).accept(e));
        ...
        public void onPlayerQuit(PlayerQuitEvent e) {
            ...
            inv.getListeners().stream()
                    ...
                    .forEach(listener -> ((libs.fr.minuskube.inv.InventoryListener<PlayerQuitEvent>) listener).accept(e));
