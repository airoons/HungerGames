...
public interface SlotIterator {
    ...
    Optional<libs.fr.minuskube.inv.ClickableItem> get();
    SlotIterator set(libs.fr.minuskube.inv.ClickableItem item);
    ...
    class Impl implements SlotIterator {
        ...
        public Impl(InventoryContents contents, libs.fr.minuskube.inv.SmartInventory inv,
        ...
        @Override
        public Optional<libs.fr.minuskube.inv.ClickableItem> get() {
